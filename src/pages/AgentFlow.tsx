      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="relative group">
            <div className="absolute -inset-1.5 animate-gradient bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 group-hover:from-pink-500 group-hover:via-purple-500 group-hover:to-blue-500 blur-lg opacity-75 group-hover:opacity-100 transition duration-3000 group-hover:duration-1000 animate-gradient-xy rounded-2xl"></div>
